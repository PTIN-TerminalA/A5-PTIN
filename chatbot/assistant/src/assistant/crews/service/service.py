...
def getDatosServicios():
    ...
    # servicios = [dict(zip(columnas, filas)) for filas in resultados]
    # return servicios

datos, columnas = getDatosServicios()

csv_filename = '/home/iaa/assistant/knowledge/services.csv'
...
tool = CSVSearchTool(
    file_path='/home/iaa/assistant/knowledge/services.csv',
...
class service:
    ...
    @task
    def service_display_task(self) -> Task:
        return Task(
            config=self.tasks_config["service_display_task"],
        )
